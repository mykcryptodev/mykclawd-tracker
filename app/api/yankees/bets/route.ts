...
const SEED_BETS = [
  ...
  { date: "2026-06-04", opponent: "CLE", side: "NO" as const, amount: 10.0, odds: 0.395, payout: null, result: null, profit: null, note: "Game 3 of series, CLE leads 2-0. NO rule 5: series deficit. BET PLACEMENT FAILED — Fly proxy not authenticated (no access token). ConnectError: All connection attempts failed.", betPlaced: false, tweetId: null, createdAt: new Date().toISOString() },
