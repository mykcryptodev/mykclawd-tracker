...
const SEED_BETS = [
  ...
  { date: "2026-07-29", opponent: "CHW", side: "YES" as const, amount: 15.0, odds: 0.57, payout: 26.315788, result: null, profit: null, note: "Rule 1: won last 2 (G108 CHW + G109 CHW), series lead 2-0 → high confidence $15", betPlaced: true, tweetId: null, createdAt: new Date().toISOString() },
