...
const SEED_BETS = [
  ...
  { date: "2026-08-23", opponent: "TOR", side: "YES" as const, amount: 10.0, odds: 0.56, payout: 17.85714, result: null, profit: null, note: "Rule 3 — bounce-back YES: Yankees lost exactly 1 after a 5-game win streak; Game 132 is exactly one game after final Game 131", betPlaced: true, tweetId: null, createdAt: new Date().toISOString() },
