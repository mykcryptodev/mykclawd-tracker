...
const SEED_BETS = [
  ...
  { date: "2026-06-16", opponent: "CHW", side: "YES" as const, amount: 10, odds: 0.3671, payout: 17.241378, result: null, profit: null, note: "2-game win streak (June 13 W + June 14 W). Rule 2: standard YES $10.", betPlaced: true, tweetId: "2066839550362538118", createdAt: new Date().toISOString() },
