...
const SEED_BETS = [
  ...
  { date: "2026-07-03", opponent: "MIN", side: "NO" as const, amount: 10.0, odds: 0.2806, payout: 25.641024, result: null, profit: null, note: "Rule 4: 7-game loss streak (L June 25 - July 1). Yankees 48-38, betting MIN to win.", betPlaced: true, tweetId: null, createdAt: new Date().toISOString() },
