...
const SEED_BETS = [
  ...
  { date: "2026-07-18", opponent: "LAD", side: "YES" as const, amount: 10.0, odds: 0.3333, payout: 20.0, result: null, profit: null, note: "Bounce-back rule: lost exactly 1 (July 17 vs LAD) after 4-game win streak (July 9-12). YES $10.", betPlaced: true, tweetId: "2078330313609023792", createdAt: new Date().toISOString() },
