...
const SEED_BETS = [
  ...
  { date: "2026-07-25", opponent: "PHI", side: "YES" as const, amount: 15.0, odds: 0.3377, payout: 29.411763, result: "WIN" as const, profit: 14.41, note: "Rule 1: W-W streak (PIT DH G2 + PHI G105 1-0 Schlittler gem) + Game 2 of series, Yankees lead 1-0 (high-confidence YES $15)", betPlaced: true, tweetId: "2080847369634013427", createdAt: new Date().toISOString() },
