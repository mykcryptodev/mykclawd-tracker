...
const SEED_BETS = [
  ...
  { date: "2026-05-29", opponent: "ATH", side: "YES" as const, amount: 10, odds: 0.585, payout: 17.09, result: "WIN" as const, profit: 7.09, note: "4-game win streak (W-TBR + KCR 3-game sweep). Rule: standard YES $10 — 2+ win streak. BET PLACEMENT FAILED x2 — Polymarket signer issue persists. USDC balance: 34.19 available but signer rejected. [Game result resolved: Yankees won 8-2 vs ATH May 29]", betPlaced: false, tweetId: null, createdAt: new Date().toISOString() },
  { date: "2026-05-30", opponent: "ATH", side: "YES" as const, amount: 15, odds: 0.585, payout: null, result: "WIN" as const, profit: -15, note: "5-game win streak + Game 2 of series (Yankees lead 1-0 vs ATH). Rule: high-confidence YES $15 (rule 1). BET PLACEMENT FAILED — bankr signer rejected (caller_not_allowed_for_operation) — same persistent error from May 29. USDC balance: 34.19 available but signer rejected. [Game result resolved: Yankees won 8-2 vs ATH May 30]", betPlaced: false, tweetId: null, createdAt: new Date().toISOString() },
  { date: "2026-05-31", opponent: "ATH", side: "YES" as const, amount: 15, odds: 0.585, payout: null, result: null, profit: null, note: "5-game win streak + Game 3 of series (Yankees lead 2-0 vs ATH). Rule: high-confidence YES $15 (rule 1). BET PLACEMENT FAILED — bankr signer rejected (caller_not_allowed_for_operation) — 4th consecutive failure since May 24. USDC balance available but signer rejected.", betPlaced: false, tweetId: null, createdAt: new Date().toISOString() },
  { date: "2026-06-02", opponent: "?", side: "YES" as const, amount: 15, odds: 0.397, payout: 22.779694, result: null, profit: null, note: "Yankees vs Cleveland June 2. FOK market order filled via py_clob_client_v2 deposit wallet flow. Order ID: 0xbca78743d29d1c1b1e36c8d23201a1dc9e0366ed9884397cb7154b4c88bcb1f6. TX: 0x73ff0675f37d6700ec75e5d2f055354ef496a9ef221ff9396c45e31351e571fb. Deposited 16 pUSD from EOA to deposit wallet 0x95E59974fD31ddf12037c189152180EfBA63201A.", betPlaced: true, tweetId: null, createdAt: new Date().toISOString() },
