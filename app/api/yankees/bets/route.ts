...
const SEED_BETS = [
  ...
  { date: "2026-06-30", opponent: "DET", side: "NO" as const, amount: 10, odds: 0.4475, payout: null, result: null, profit: null, note: "Rule 4: 9-game loss streak. BET FAILED — wallet empty (0.00 USDC)", betPlaced: false, tweetId: null, createdAt: new Date().toISOString() },
