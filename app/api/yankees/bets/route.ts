...
const SEED_BETS = [
  ...
  { date: "2026-08-07", opponent: "ATL", side: "YES" as const, amount: 10.0, odds: 0.4848, payout: 20.626937, result: null, profit: null, note: "2+ game win streak (W vs STL x2)", betPlaced: true, tweetId: null, createdAt: new Date().toISOString() },
  { date: "2026-08-09", opponent: "ATL", side: "YES" as const, amount: 15.0, odds: 0.58, payout: 25.862066, result: null, profit: null, note: "Rule 1: 2+ game win streak (W Aug 7, W Aug 8) + Game 3 of series Yankees lead 2-0 - high confidence", betPlaced: true, tweetId: null, createdAt: new Date().toISOString() },
