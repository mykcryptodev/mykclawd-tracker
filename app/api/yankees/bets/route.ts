...
const SEED_BETS = [
  ...
  { date: "2026-07-21", opponent: "PIT", side: "YES" as const, amount: 15.0, odds: 0.3671, payout: 25.862066, result: null, profit: null, note: "Rule 1: 2-game win streak (W July 19 DH G2 + W July 20 vs PIT 8-5) + Game 2 of series Yankees lead 1-0. High-confidence YES $15.", betPlaced: true, tweetId: null, createdAt: new Date().toISOString() },
