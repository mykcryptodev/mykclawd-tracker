...
const SEED_BETS = [
  ...
  { date: "2026-07-18", opponent: "LAD", side: "YES" as const, amount: 10.0, odds: 0.3333, payout: 20.0, result: "LOSS" as const, profit: -10.0, note: "Bounce-back rule: YES $10. Game played July 19 DH Game 1: LAD 8, NYY 2. Yamamoto CG (9IP, 4H, 7K). LOSS.", betPlaced: true, tweetId: "2078330313609023792", createdAt: new Date().toISOString() },
  { date: "2026-07-19", opponent: "LAD", side: "NO" as const, amount: 10.0, odds: 0.3464, payout: 18.867923, result: null, profit: null, note: "Rule 5: series deficit — LAD leads series 2-0 (W July 17 + W DH Game 1, Yamamoto CG). Game 3 NO bet.", betPlaced: true, tweetId: "2078935493002035514", createdAt: new Date().toISOString() },
