...
const SEED_BETS = [
  ...
  { date: "2026-08-04", opponent: "STL", side: "NO" as const, amount: 10.0, odds: 0.39, payout: 25.641024, result: "LOSS" as const, profit: -10.3, note: "Series deficit — STL leads series 1-0, today is Game 2", betPlaced: true, tweetId: null, createdAt: new Date().toISOString() },
