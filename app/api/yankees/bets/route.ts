...
const SEED_BETS = [
  ...
  { date: "2026-07-11", opponent: "WAS", side: "YES" as const, amount: 15.0, odds: 0.3902, payout: 23.4375, result: null, profit: null, note: "2-game win streak (W July 9 vs TBR 12-4, W July 10 vs WAS 5-3) + Game 2 of series (Yankees lead 1-0 vs WAS). Rule 1: high-confidence YES $15.", betPlaced: true, tweetId: null, createdAt: new Date().toISOString() },
