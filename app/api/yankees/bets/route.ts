...
const SEED_BETS = [
  ...
  { date: "2026-06-29", opponent: "DET", side: "NO" as const, amount: 10.0, odds: 0.3056, payout: 22.727271, result: null, profit: null, note: "Rule 4: 4-game loss streak (L June 25, 26, 27, 28). NO bet on Yankees, betting DET to win.", betPlaced: true, tweetId: null, createdAt: new Date().toISOString() },
