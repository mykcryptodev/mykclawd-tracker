...
const SEED_BETS = [
  ...
  { date: "2026-05-29", opponent: "?", side: "YES" as const, amount: 10, odds: 0.575, payout: null, result: null, profit: null, note: "3-game win streak (KCR sweep W4-3, W15-1, W7-0). Rule: standard YES $10 — 2+ win streak. BET PLACEMENT FAILED — signer rejected: caller_not_allowed_for_operation.", betPlaced: false, tweetId: null, createdAt: new Date().toISOString() },
