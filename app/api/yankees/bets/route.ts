...
const SEED_BETS = [
  ...
  { date: "2026-06-17", opponent: "CWS", side: "YES" as const, amount: 15.0, odds: 0.625, payout: 23.809521, result: null, profit: null, note: "3-game win streak + Game 2 of CHW series + Yankees lead 1-0. Rule 1: YES $15 high confidence.", betPlaced: true, tweetId: "2067096208565207392", createdAt: new Date().toISOString() },
