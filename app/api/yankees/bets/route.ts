...
const SEED_BETS = [
  ...
  { date: "2026-06-03", opponent: "CLE", side: "NO" as const, amount: 10.0, odds: 0.2908, payout: 24.390242, result: null, profit: null, note: "Game 2 of series, CLE leads 1-0 (won Game 61 9-4). NO rule 5: series deficit 0. Gavin Williams (8-3, 3.07) vs Gerrit Cole (1-0, 0.00, limited sample).", betPlaced: true, tweetId: null, createdAt: new Date().toISOString() },
