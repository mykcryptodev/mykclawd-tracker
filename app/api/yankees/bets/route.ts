...
const SEED_BETS = [
  ...
  { date: "2026-06-25", opponent: "BOS", side: "YES" as const, amount: 10.0, odds: 0.375, payout: 16.666665, result: null, profit: null, note: "2+ win streak (W2)", betPlaced: true, tweetId: null, createdAt: new Date().toISOString() },
