...
const SEED_BETS = [
  ...
  { date: "2026-05-24", opponent: "TB", side: "NO" as const, amount: 10, odds: 0.51, payout: null, result: null, profit: null, note: "3-game losing streak (L vs TBR, L vs TOR x2). Rule: NO $10 — lost last 3 in a row (L3). Bet placement FAILED TWICE — (1) bankr JSON parse error, (2) TLS cert validation error (ERR_TLS_CERT_ALTNAME_INVALID) on Polymarket order service. | Outcome: Yankees WON 2-0 (Judge walk-off HR) — bet would have LOST. Unplaced due to TLS error.", betPlaced: false, tweetId: null, createdAt: new Date().toISOString() },
