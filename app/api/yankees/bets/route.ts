...
const SEED_BETS = [
  ...
  { date: "2026-06-27", opponent: "BOS", side: "NO" as const, amount: 10.0, odds: 0.3197, payout: 21.276594, result: null, profit: null, note: "Rule 5: series deficit — BOS leads series 2-0, this is Game 3", betPlaced: true, tweetId: "2070721173407637738", createdAt: new Date().toISOString() },
