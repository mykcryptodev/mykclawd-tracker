...
const SEED_BETS = [
  ...
  { date: "2026-06-12", opponent: "TOR", side: "YES" as const, amount: 10, odds: 0.3421, payout: 19.230768, result: null, profit: null, note: "4-game win streak (W June 7,8,9,10). Rule 2: standard YES $10 — 2+ win streak, Game 1 of new series vs TOR.", betPlaced: true, tweetId: "2064921870902665665", createdAt: new Date().toISOString() },
