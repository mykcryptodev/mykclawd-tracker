...
const SEED_BETS = [
  ...
  { date: "2026-08-20", opponent: "BAL", side: "YES" as const, amount: 15.0, odds: 0.53, payout: 28.301885, result: null, profit: null, note: "Rule 1: won last 2+ (Aug 18 at BAL + Aug 19 at BAL) and Game 3 of series Yankees lead 2-0 - high confidence YES", betPlaced: true, tweetId: null, createdAt: new Date().toISOString() },
