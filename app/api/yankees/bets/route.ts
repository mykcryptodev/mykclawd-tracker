...
const SEED_BETS = [
  ...
  { date: "2026-06-18", opponent: "CHW", side: "YES" as const, amount: 15.0, odds: 0.585, payout: 25.423727, result: null, profit: null, note: "4-game win streak + Game 3 of CHW series, Yankees lead 2-0. Rule 1: YES $15 high confidence.", betPlaced: true, tweetId: null, createdAt: new Date().toISOString() },
