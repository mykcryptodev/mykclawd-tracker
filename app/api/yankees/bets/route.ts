...
const SEED_BETS = [
  ...
  { date: "2026-06-26", opponent: "BOS", side: "NO" as const, amount: 10.0, odds: 0.3289, payout: 20.408162, result: null, profit: null, note: "Rule 5: Game 2 of series, BOS leads 1-0 (won Game 82 6-3 June 25). NO $10 series deficit.", betPlaced: true, tweetId: null, createdAt: new Date().toISOString() },
