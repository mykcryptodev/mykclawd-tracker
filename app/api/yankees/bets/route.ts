...
const SEED_BETS = [
  ...
  { date: "2026-07-12", opponent: "WAS", side: "YES" as const, amount: 15.0, odds: 0.3377, payout: 29.411763, result: null, profit: null, note: "Rule 1: 3-game win streak + Game 3 of series Yankees lead 2-0 (high-confidence YES $15)", betPlaced: true, tweetId: "2076155960494604736", createdAt: new Date().toISOString() },
