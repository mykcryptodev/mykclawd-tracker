...
const SEED_BETS = [
  ...
  { date: "2026-07-26", opponent: "PHI", side: "YES" as const, amount: 15.0, odds: 0.2857, payout: 37.5, result: "LOSS" as const, profit: -15.0, note: "Rule 1: won last 2+ (G105+G106 W), series lead 2-0 → high confidence 5", betPlaced: true, tweetId: null, createdAt: new Date().toISOString() },
