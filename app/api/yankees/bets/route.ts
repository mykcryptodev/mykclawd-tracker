...
const SEED_BETS = [
  ...
  { date: "2026-08-22", opponent: "TOR", side: "YES" as const, amount: 15.0, odds: 0.53, payout: 28.301885, result: null, profit: null, note: "Rule 1: Yankees won last 2+ and Game 2 of series vs TOR with Yankees leading 1-0 after Game 130 — high-confidence YES", betPlaced: true, tweetId: null, createdAt: new Date().toISOString() },
