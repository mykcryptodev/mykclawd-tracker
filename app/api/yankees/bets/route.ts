...
const SEED_BETS = [
  ...
  { date: "2026-07-27", opponent: "CWS", side: "YES" as const, amount: 10.0, odds: 0.3631, payout: 17.543858, result: null, profit: null, note: "Bounce-back rule: lost 1 after 3+ win streak (W,W,W then L vs PHI G107)", betPlaced: true, tweetId: null, createdAt: new Date().toISOString() },
