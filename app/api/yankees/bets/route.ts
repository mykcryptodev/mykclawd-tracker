...
const SEED_BETS = [
  ...
  { date: "2026-06-06", opponent: "BOS", side: "NO" as const, amount: 10.0, odds: 0.3151, payout: 21.739129, result: null, profit: 0, note: "NO bet (BOS win token). Game 2 of series, BOS leads 1-0. NO rule 5: series deficit. | GAME POSTPONED — Rain. Rescheduled Aug 29. Market voided/refunded.", betPlaced: true, tweetId: "2063110815985660245", createdAt: new Date().toISOString() },
  { date: "2026-06-07", opponent: "BOS", side: "NO" as const, amount: 10.0, odds: 0.2857, payout: 25.0, result: null, profit: null, note: "Game 2 of series, BOS leads 1-0 (won June 5, 5-3; June 6 PPD). NO rule 5: series deficit.", betPlaced: true, tweetId: "2063472981691478525", createdAt: new Date().toISOString() },
