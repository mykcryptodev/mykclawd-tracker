...
const SEED_BETS = [
  ...
  { date: "2026-06-16", opponent: "CHW", side: "YES" as const, amount: 10, odds: 0.5, payout: null, result: null, profit: null, note: "2-game win streak (June 13 W + June 14 W). Rule 2: standard YES $10. Market not yet available on Polymarket (2 days out) — odds placeholder 0.5 on Polymarket (2 days out) — will retry when market opens.", betPlaced: false, tweetId: null, createdAt: new Date().toISOString() },
