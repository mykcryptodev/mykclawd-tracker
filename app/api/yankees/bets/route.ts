...
const SEED_BETS = [
  ...
  { date: "2026-07-17", opponent: "LAD", side: "YES" as const, amount: 10.0, odds: 0.3197, payout: 21.276594, result: null, profit: null, note: "Rule 2: 4-game win streak going into All-Star break (W July 9-12). Game 1 of LAD series.", betPlaced: true, tweetId: null, createdAt: new Date().toISOString() },
