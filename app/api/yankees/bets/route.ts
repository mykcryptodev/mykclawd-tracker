...
const SEED_BETS = [
  ...
  { date: "2026-06-06", opponent: "BOS", side: "NO" as const, amount: 10.0, odds: 0.3151, payout: 21.739129, result: null, profit: null, note: "NO bet (BOS win token). Game 2 of series, BOS leads 1-0. NO rule 5: series deficit.", betPlaced: true, tweetId: "2063110815985660245", createdAt: new Date().toISOString() },
