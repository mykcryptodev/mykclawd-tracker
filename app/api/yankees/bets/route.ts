...
const SEED_BETS = [
  ...
  { date: "2026-05-29", opponent: "OAK", side: "YES" as const, amount: 10, odds: 0.585, payout: null, result: null, profit: null, note: "4-game win streak (W-TBR + KCR 3-game sweep). Rule: standard YES $10 — 2+ win streak. BET PLACEMENT FAILED x2 — Polymarket signer issue persists. USDC balance: 34.19 available but signer rejected.", betPlaced: false, tweetId: null, createdAt: new Date().toISOString() },
