...
const SEED_BETS = [
  ...
  { date: "2026-06-06", opponent: "BOS", side: "NO" as const, amount: 10.0, odds: 0.3151, payout: null, result: "VOID" as const, profit: 0, note: "NO bet (BOS win token). Game 2 of series, BOS leads 1-0. NO rule 5: series deficit. | GAME POSTPONED — Rain. Rescheduled Aug 29. Market voided & $10 stake refunded.", betPlaced: true, tweetId: "2063110815985660245", createdAt: new Date().toISOString() },
  ...
  { date: "2026-06-09", opponent: "CLE", side: "YES" as const, amount: 15.0, odds: 0.3548, payout: 27.272726, result: null, profit: null, note: "W-W streak (NYY 6-1 vs BOS June 7, NYY 7-5 vs CLE June 8). Rule 1: high-confidence 5 — 2+ win streak + Game 2 of series (Yankees lead 1-0 vs CLE).", betPlaced: true, tweetId: "2064197211831841274", createdAt: new Date().toISOString() },
