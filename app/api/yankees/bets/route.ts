...
const SEED_BETS = [
  ...
  { date: "2026-06-13", opponent: "TOR", side: "YES" as const, amount: 10, odds: 0.3506, payout: 18.518517, result: null, profit: null, note: "Bounce-back rule: lost exactly 1 game after 4-game win streak (June 7-10). YES $10.", betPlaced: true, tweetId: "2065646767400509850", createdAt: new Date().toISOString() },
