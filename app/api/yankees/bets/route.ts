...
const SEED_BETS = [
  ...
  { date: "2026-08-21", opponent: "TOR", side: "YES" as const, amount: 10.0, odds: 0.6664, payout: 15.006715, result: null, profit: null, note: "Rule 2: Yankees won last 2+ (Aug 18 at BAL + Aug 19 at BAL + W3 active) - standard YES for Game 130 series opener", betPlaced: true, tweetId: null, createdAt: new Date().toISOString() },
