...
const SEED_BETS = [
  ...
  { date: "2026-06-28", opponent: "BOS", side: "NO" as const, amount: 10.0, odds: 0.3464, payout: 18.867923, result: null, profit: null, note: "Rule 4: 3-game loss streak (L June 25, 26, 27 vs BOS). Also Rule 5: BOS leads series 3-0, Game 4.", betPlaced: true, tweetId: null, createdAt: new Date().toISOString() },
