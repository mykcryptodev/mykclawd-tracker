...
const SEED_BETS = [
  ...
  { date: "2026-06-10", opponent: "CLE", side: "YES" as const, amount: 15.0, odds: 0.3289, payout: 30.612243, result: null, profit: null, note: "Rule 1: 3-game win streak (W June 7,8,9) + Game 3 of series + Yankees lead 2-0 vs CLE", betPlaced: true, tweetId: "2064567867907924424", createdAt: new Date().toISOString() },
