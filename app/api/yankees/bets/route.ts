...
const SEED_BETS = [
  ...
  { date: "2026-06-19", opponent: "CIN", side: "YES" as const, amount: 10, odds: 0.695, payout: null, result: null, profit: null, note: "Bounce-back rule: lost exactly 1 (June 18 vs CHW) after 4-game win streak (June 13-17). BET PLACEMENT FAILED — Polymarket order manager not ready (3 consecutive attempts). USDC proxy tunnel active (port 1080) but CLOB rejecting orders.", betPlaced: false, tweetId: null, createdAt: new Date().toISOString() },
