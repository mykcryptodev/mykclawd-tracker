...
const SEED_BETS = [
  ...
  { date: "2026-05-29", opponent: "ATH", side: "YES" as const, amount: 10, odds: 0.585, payout: 17.09, result: "WIN" as const, profit: 7.09, note: "4-game win streak (W-TBR + KCR 3-game sweep). Rule: standard YES $10 — 2+ win streak. Yankees won 8-2 vs ATH May 29 (Rodón W, Goldschmidt 3-run HR).", betPlaced: false, tweetId: null, createdAt: new Date().toISOString() },
  { date: "2026-05-30", opponent: "ATH", side: "YES" as const, amount: 15, odds: 0.585, payout: null, result: "LOSS" as const, profit: -15, note: "5-game win streak + Game 2 of series (Yankees lead 1-0 vs ATH). Rule: high-confidence YES $15 (rule 1). Yankees lost 6-4 vs ATH (Langeliers, Kurtz, Soderstrom HRs).", betPlaced: false, tweetId: null, createdAt: new Date().toISOString() },
  { date: "2026-05-31", opponent: "ATH", side: "YES" as const, amount: 10, odds: 0.585, payout: null, result: null, profit: null, note: "Bounce-back (lost 1 after 5W streak). Rule: standard YES $10 — series tied 1-1 vs ATH going into Game 3.", betPlaced: false, tweetId: null, createdAt: new Date().toISOString() },
