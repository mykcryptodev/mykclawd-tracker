...
const SEED_BETS = [
  ...
  { date: "2026-07-01", opponent: "DET", side: "NO" as const, amount: 10.0, odds: 0.3056, payout: 22.727271, result: null, profit: null, note: "Rule 4: 6-game loss streak (L June 25-30). Also Rule 5: DET leads series 2-0, Game 3.", betPlaced: true, tweetId: "2072170081396699420", createdAt: new Date().toISOString() },
