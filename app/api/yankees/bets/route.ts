...
const SEED_BETS = [
  ...
  { date: "2026-05-27", opponent: "?", side: "YES" as const, amount: 15, odds: 0.585, payout: 25.64, result: null, profit: null, note: "3-game win streak + Game 3 of series (Yankees lead 2-0 vs KCR). Rule: high-confidence ($15) — series lead Game 2+.", betPlaced: true, tweetId: null, createdAt: new Date().toISOString() },
