...
const SEED_BETS = [
  ...
  { date: "2026-06-04", opponent: "CLE", side: "NO" as const, amount: 10.0, odds: 0.4, payout: 25.0, result: "LOSS" as const, profit: -10, note: "Game 3 of series, CLE leads 2-0. NO rule 5: series deficit. BUY CLE token (Yankees lose). Retry after Fly proxy fix (204.8.219.79:1080). Order matched.", betPlaced: true, tweetId: null, createdAt: new Date().toISOString() },
  ...
  { date: "2026-06-07", opponent: "BOS", side: "NO" as const, amount: 10.0, odds: 0.4, payout: 25.0, result: "LOSS" as const, profit: -10, note: "Game 2 of series, BOS leads 1-0 (won June 5, 5-3; June 6 PPD). NO rule 5: series deficit.", betPlaced: true, tweetId: "2063472981691478525", createdAt: new Date().toISOString() },
  { date: "2026-06-09", opponent: "CLE", side: "YES" as const, amount: 15.0, odds: 0.55, payout: 27.272726, result: "WIN" as const, profit: 12.27, note: "W-W streak (NYY 6-1 vs BOS June 7, NYY 7-5 vs CLE June 8). Rule 1: high-confidence 5 — 2+ win streak + Game 2 of series (Yankees lead 1-0 vs CLE).", betPlaced: true, tweetId: "2064197211831841274", createdAt: new Date().toISOString() },
  { date: "2026-06-10", opponent: "CLE", side: "YES" as const, amount: 15.0, odds: 0.49, payout: 30.612243, result: "WIN" as const, profit: 15.61, note: "Rule 1: 3-game win streak (W June 7,8,9) + Game 3 of series + Yankees lead 2-0 vs CLE", betPlaced: true, tweetId: "2064567867907924424", createdAt: new Date().toISOString() },
  { date: "2026-06-12", opponent: "TOR", side: "YES" as const, amount: 10, odds: 0.52, payout: 19.230768, result: "LOSS" as const, profit: -10.0, note: "4-game win streak (W June 7,8,9,10). Rule 2: standard YES $10 — 2+ win streak, Game 1 of new series vs TOR.", betPlaced: true, tweetId: "2064921870902665665", createdAt: new Date().toISOString() },
  { date: "2026-06-13", opponent: "TOR", side: "YES" as const, amount: 10, odds: 0.54, payout: 18.518517, result: "WIN" as const, profit: 8.52, note: "Bounce-back rule: lost exactly 1 game after 4-game win streak (June 7-10). YES $10.", betPlaced: true, tweetId: "2065646767400509850", createdAt: new Date().toISOString() },
  { date: "2026-06-16", opponent: "CHW", side: "YES" as const, amount: 10, odds: 0.58, payout: 17.241378, result: "WIN" as const, profit: 7.24, note: "2-game win streak (June 13 W + June 14 W). Rule 2: standard YES $10.", betPlaced: true, tweetId: "2066839550362538118", createdAt: new Date().toISOString() },
  { date: "2026-06-17", opponent: "CWS", side: "YES" as const, amount: 15.0, odds: 0.63, payout: 23.809521, result: "WIN" as const, profit: 8.81, note: "3-game win streak + Game 2 of CHW series + Yankees lead 1-0. Rule 1: YES $15 high confidence.", betPlaced: true, tweetId: "2067096208565207392", createdAt: new Date().toISOString() },
  { date: "2026-06-18", opponent: "CHW", side: "YES" as const, amount: 15.0, odds: 0.59, payout: 25.423727, result: "LOSS" as const, profit: -15, note: "4-game win streak + Game 3 of CHW series, Yankees lead 2-0. Rule 1: YES $15 high confidence.", betPlaced: true, tweetId: null, createdAt: new Date().toISOString() },
  { date: "2026-06-19", opponent: "CIN", side: "YES" as const, amount: 10, odds: 0.71, payout: 14.084506, result: "WIN" as const, profit: 4.08, note: "Bounce-back rule: lost exactly 1 (June 18 vs CHW) after 4-game win streak (June 13-17). Retry after order manager rejection.", betPlaced: true, tweetId: null, createdAt: new Date().toISOString() },
  { date: "2026-06-23", opponent: "DET", side: "NO" as const, amount: 10.0, odds: 0.48, payout: 20.833332, result: "LOSS" as const, profit: -10.0, note: "3-game losing streak (L vs CIN x2, L vs DET G1). Rule 4: NO $10 loss streak.", betPlaced: true, tweetId: "2069271772843712921", createdAt: new Date().toISOString() },
  { date: "2026-06-25", opponent: "BOS", side: "YES" as const, amount: 10.0, odds: 0.6, payout: 16.666665, result: "LOSS" as const, profit: -10.0, note: "2+ win streak (W2)", betPlaced: true, tweetId: null, createdAt: new Date().toISOString() },
  { date: "2026-06-26", opponent: "BOS", side: "NO" as const, amount: 10.0, odds: 0.49, payout: 20.408162, result: "WIN" as const, profit: 10.41, note: "Rule 5: Game 2 of series, BOS leads 1-0 (won Game 82 6-3 June 25). NO $10 series deficit. BOS won 6-1 (Tolle 7IP 1H 7K, Contreras 3 RBI). NO bet hit.", betPlaced: true, tweetId: null, createdAt: new Date().toISOString() },
  { date: "2026-06-27", opponent: "BOS", side: "NO" as const, amount: 10.0, odds: 0.47, payout: 21.276594, result: "WIN" as const, profit: 11.28, note: "Rule 5: series deficit — BOS leads series 2-0, this is Game 3. BOS won 4-1 (Jake Bennett W 2-3, 6.1IP; Cole L 2-3; Yoshida HR, Contreras 2-RBI 2B, Seigler 1st MLB HR). NO bet hit.", betPlaced: true, tweetId: "2070721173407637738", createdAt: new Date().toISOString() },
  { date: "2026-06-28", opponent: "BOS", side: "NO" as const, amount: 10.0, odds: 0.53, payout: 18.867923, result: "WIN" as const, profit: 8.87, note: "Rule 4: 3-game loss streak (L June 25, 26, 27 vs BOS). Also Rule 5: BOS leads series 3-0, Game 4.", betPlaced: true, tweetId: "2071083360286335061", createdAt: new Date().toISOString() },
  { date: "2026-06-29", opponent: "DET", side: "NO" as const, amount: 10.0, odds: 0.44, payout: 22.727271, result: "WIN" as const, profit: 12.73, note: "Rule 4: 4-game loss streak (L June 25, 26, 27, 28). NO bet on Yankees, betting DET to win.", betPlaced: true, tweetId: "2071600055446835424", createdAt: new Date().toISOString() },
  { date: "2026-06-30", opponent: "DET", side: "NO" as const, amount: 10, odds: 0.444, payout: 22.522521, result: "WIN" as const, profit: 12.52, note: "Rule 4: 9-game loss streak. Betting DET wins.", betPlaced: true, tweetId: null, createdAt: new Date().toISOString() },
  { date: "2026-07-01", opponent: "DET", side: "NO" as const, amount: 10.0, odds: 0.44, payout: 22.727271, result: "WIN" as const, profit: 12.73, note: "Rule 4: 6-game loss streak (L June 25-30). Also Rule 5: DET leads series 2-0, Game 3. Tigers 6, Yankees 2 (11 inn.) — DET swept series. NO bet hit.", betPlaced: true, tweetId: "2072170081396699420", createdAt: new Date().toISOString() },
  { date: "2026-07-03", opponent: "MIN", side: "NO" as const, amount: 10.0, odds: 0.39, payout: 25.641024, result: "LOSS" as const, profit: -10.0, note: "Rule 4: 7-game loss streak (L June 25 - July 1). Yankees 48-38, betting MIN to win.", betPlaced: true, tweetId: "2073256709397647515", createdAt: new Date().toISOString() },
  { date: "2026-07-11", opponent: "WAS", side: "YES" as const, amount: 15.0, odds: 0.64, payout: 23.4375, result: "WIN" as const, profit: 8.44, note: "2-game win streak (W July 9 vs TBR 12-4, W July 10 vs WAS 5-3) + Game 2 of series (Yankees lead 1-0 vs WAS). Rule 1: high-confidence YES $15.", betPlaced: true, tweetId: "2075911055579009085", createdAt: new Date().toISOString() },
  { date: "2026-07-12", opponent: "WAS", side: "YES" as const, amount: 15.0, odds: 0.51, payout: 29.411763, result: "WIN" as const, profit: 14.41, note: "Rule 1: 3-game win streak + Game 3 of series Yankees lead 2-0 (high-confidence YES $15)", betPlaced: true, tweetId: "2076155960494604736", createdAt: new Date().toISOString() },
  { date: "2026-07-17", opponent: "LAD", side: "YES" as const, amount: 10.0, odds: 0.47, payout: 21.276594, result: "LOSS" as const, profit: -10.0, note: "Rule 2: 4-game win streak going into All-Star break (W July 9-12). Game 1 of LAD series.", betPlaced: true, tweetId: null, createdAt: new Date().toISOString() },
  ...
  { date: "2026-07-22", opponent: "PIT", side: "YES" as const, amount: 15.0, odds: 0.59, payout: 25.423726, result: "LOSS" as const, profit: -15.0, note: "Rule 1: 2-game win streak (W July 19 DH G2 + W July 20 vs PIT 8-5) + Game 2 of series Yankees lead 1-0. High-confidence YES $15.", betPlaced: true, tweetId: "2079779953848074722", createdAt: new Date().toISOString() },
  { date: "2026-07-25", opponent: "PHI", side: "YES" as const, amount: 15.0, odds: 0.51, payout: 29.411763, result: "WIN" as const, profit: 14.41, note: "Rule 1: W-W streak (PIT DH G2 + PHI G105 1-0 Schlittler gem) + Game 2 of series, Yankees lead 1-0 (high-confidence YES $15)", betPlaced: true, tweetId: "2081201302546108747", createdAt: new Date().toISOString() },
  { date: "2026-07-26", opponent: "PHI", side: "YES" as const, amount: 15.0, odds: 0.4, payout: 37.5, result: "LOSS" as const, profit: -15.0, note: "Rule 1: won last 2+ (G105+G106 W), series lead 2-0 → high confidence 5", betPlaced: true, tweetId: "2081581824719954292", createdAt: new Date().toISOString() },
  { date: "2026-07-27", opponent: "CHW", side: "YES" as const, amount: 10.0, odds: 0.57, payout: 17.543858, result: "WIN" as const, profit: 7.54, note: "Bounce-back rule: lost 1 after 3+ win streak (W,W,W then L vs PHI G107)", betPlaced: true, tweetId: "2081949508171186570", createdAt: new Date().toISOString() },
