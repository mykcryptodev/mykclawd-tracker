...
const BETS: (typeof yankeesBets.$inferInsert)[] = [
  ...
  { date: "2026-05-24", opponent: "TB", side: "NO", amount: 10, odds: 0.51, payout: null, result: null, profit: null, note: "3-game losing streak — bet placement failed (TLS error)", betPlaced: false, tweetId: null, createdAt: new Date().toISOString() },
];
